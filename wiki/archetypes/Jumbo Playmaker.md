...
Playmaking at size. Physical mismatch is the product — big enough to see over guards, strong enough to finish in traffic, with the vision and passing of a point guard.
